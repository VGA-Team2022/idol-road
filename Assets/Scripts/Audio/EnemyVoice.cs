...
public class EnemyVoice : MonoBehaviour
{
    ...
    public int[] GetNormalEnemyVoiceID(EnemySprites enemySprite)
    {
        var voiceID = new int[VOICE_ID_SIZE];

        switch (enemySprite)
        {
            case EnemySprites.Mine:
                voiceID[0] = 2;
                voiceID[1] = 9;
                break;
            case EnemySprites.JK:
                voiceID[0] = 3;
                voiceID[1] = 11;
                break;
            case EnemySprites.Glasses:
                voiceID[0] = 7;
                voiceID[1] = 12;
                break;
            case EnemySprites.Handsome:
                voiceID[0] = 4;
                voiceID[1] = 10;
                break;       
        }
